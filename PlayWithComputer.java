...
public class PlayWithComputer {
    public static void main(String args[]) {    
        ...
        HumanPlayer p1 = new HumanPlayer("Aabis", 'x'); //Player 1 - Constructor is ready to receive name and mark. 
        AIPlayer p2 = new AIPlayer("AI", 'o'); //Play   er 2 - Constructor is ready to receive name and mark. 
        System.out.println();
        System.out.println();
        System.out.println();
